...
<!-- Breadcrumbs-->
 ...
 <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-users"></i> Actualizar de Miembros </div>
        <div class="card-body">
        	<div class="ver">
        	{!! Form::model($miembro, ['route' => ['miembros.update', $miembro->id], 'method'=>'PUT']) !!}
        	<fieldset>
			...
			<legend>Datos de Residencia</legend>
				...
				<div>
				   ...
				   {!!Form::text('departamento', null, array('required'=>'required'))!!}
				   {!!Form::label('ciudad', 'Municipio: ') !!}
				   {!!Form::text('ciudad', null, array('required'=>'required'))!!}	
				</div>
			</fieldset><br>
			<fieldset>
